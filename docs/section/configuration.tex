...
Enlace R2-R3 & 172.16.202.12 & /30 & 172.16.202.13 & 172.16.202.14 & 172.16.202.15 \\
\bottomrule
\end{tabularx}
\end{table}
...
Enlace R2-R3 & 2001:dbe:bef9:ff02::/64 & 2001:dbe:bef9:ff02::1 \\
\bottomrule
\end{tabularx}
\end{table}
...
\subsection{Configuración de los Servidores}

El servidor de servicios se implementa sobre Linux con dirección fija en la
subred \texttt{172.16.202.0/29} y su equivalente IPv6 en \texttt{2001:dbe:bef9:10::/64}.
Sobre este host se despliegan el servidor web, el servidor de correo y el
servidor de chat. La asignación fija es necesaria para asegurar que los clientes
de todas las LAN puedan localizar los servicios de forma consistente sin depender
de mecanismos dinámicos de descubrimiento.

El acceso remoto al servidor se realiza mediante SSHv2, y se restringe el
conjunto de puertos expuestos mediante una política de firewall que permite
únicamente los servicios requeridos por el proyecto. Esta configuración reduce
la superficie de ataque y mantiene aislados los procesos que no forman parte
de la implementación funcional del sistema.
